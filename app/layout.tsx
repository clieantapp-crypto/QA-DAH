...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    ...
    const unsubVisitors = subscribeToVisitors((data: SetStateAction<VisitorData[]>) => {
      setVisitors(data)
      setIsLoading(false)
    })

    const unsubForms = subscribeToFormSubmissions((data: SetStateAction<FormSubmission[]>) => {
      setFormSubmissions(data)
    })

    const unsubOnline = getOnlineVisitorsCount((count: SetStateAction<number>) => {
